	...
	<view>
		<scroll-view scroll-y class="page">
			...
			<view class="cu-list grid no-border col-3">
				...
				<view class="cu-item">
					<navigator hover-class="none" url="../car/myCarRecordList?status=1" open-type="navigate">
						<text class="text-orange text-lg">{{carData.waitCheckCount}}</text>
						<text>待审批</text>
					</navigator>
				</view>
				<view class="cu-item">
					<navigator hover-class="none" url="../car/myCarRecordList?status=0" open-type="navigate">
				...
				<view class="cu-item">
					<navigator hover-class="none" url="../car/myCarRecordList?status=-2" open-type="navigate">
