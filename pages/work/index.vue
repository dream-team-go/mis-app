	...
	<view>
		<scroll-view scroll-y class="page">
			...
			<view class="cu-list grid" :class="['col-' + gridCol,gridBorder?'':'no-border']"
				v-if="meetingCuIconListPermission.length > 0">
				<view hover-class="navigator-hover" class="cu-item" v-for="(item,index) in meetingCuIconListPermission"
					:key="index" @tap="navigateTo(item.url)">
					<view>
						<image :src="item.icoSrc" class="item-ico">
							<view class="cu-tag badge" v-if="item.badge!=0">
								<block v-if="item.badge!=1">{{item.badge>99?'99+':item.badge}}</block>
			...
			<view class="cu-list grid" :class="['col-' + gridCol,gridBorder?'':'no-border']"
				v-if="foodCuIconListPermission.length > 0">
				<view hover-class="navigator-hover" class="cu-item" v-for="(item,index) in foodCuIconListPermission"
					:key="index" @tap="navigateTo(item.url)">
					<view>
						<view>
							<image :src="item.icoSrc" class="item-ico">
			...
			<view class="cu-list grid" :class="['col-' + gridCol,gridBorder?'':'no-border']"
				v-if="receptionCuIconListPermission.length > 0">
				<view hover-class="navigator-hover" class="cu-item"
					v-for="(item,index) in receptionCuIconListPermission" :key="index" @tap="navigateTo(item.url)">
					<view>
						<image :src="item.icoSrc" class="item-ico">
							<view class="cu-tag badge" v-if="item.badge!=0">
								<block v-if="item.badge!=1">{{item.badge>99?'99+':item.badge}}</block>
			...
			<view class="cu-list grid" :class="['col-' + gridCol,gridBorder?'':'no-border']"
				v-if="lostFindCuIconListPermission.length > 0">
				<view hover-class="navigator-hover" class="cu-item" v-for="(item,index) in lostFindCuIconListPermission"
					:key="index" @tap="navigateTo(item.url)">
					<view>
						<image :src="item.icoSrc" class="item-ico">
							<view class="cu-tag badge" v-if="item.badge!=0">
			...
			<view class="cu-list grid" :class="['col-' + gridCol,gridBorder?'':'no-border']"
				v-if="fixCuIconListPermission.length > 0">
				<view hover-class="navigator-hover" class="cu-item" v-for="(item,index) in fixCuIconListPermission"
					:key="index" @tap="navigateTo(item.url)">
					<view>
						<image :src="item.icoSrc" class="item-ico">
							<view class="cu-tag badge" v-if="item.badge!=0">
