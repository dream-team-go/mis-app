<template>
	<view>
		<cu-custom bgColor="bg-linear-blue" :isBack="true">
			...
			<block slot="right"><view v-show="info.status == 2 || info.status == 3" @tap="saveRepairOrder">维修单</view></block>
			<block slot="right"><view v-show="info.status > 3 || info.status < -1" @tap="toRepairOrderDetail">维修单</view></block>
