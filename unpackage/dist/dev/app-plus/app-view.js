...
var x=['./pages/account/login.wxml','./pages/index/index.wxml'];d_[x[0]]={}
...
_(lK,aL)
_(oJ,lK)
var tM=_mz(z,'input',['bindinput',11,'data-event-opts',1,'data-key',2,'maxlength',3,'placeholder',4,'type',5,'value',6],[],e,s,gg)
_(oJ,tM)
_(cI,oJ)
var eN=_n('view')
...
_(bO,oP)
_(eN,bO)
var xQ=_mz(z,'input',['password',-1,'bindconfirm',21,'bindinput',1,'data-event-opts',2,'data-key',3,'maxlength',4,'placeholder',5,'placeholderClass',6,'type',7,'value',8],[],e,s,gg)
_(eN,xQ)
_(cI,eN)
_(oD,cI)
var oR=_mz(z,'button',['bindtap',30,'class',1,'data-event-opts',2,'disabled',3],[],e,s,gg)
...
_(oV,cW)
var oX=_mz(z,'text',['bindtap',39,'data-event-opts',1],[],e,s,gg)
