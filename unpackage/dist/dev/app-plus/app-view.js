...
var oHB=_mz(z,'car',['bind:__l',1,'vueId',1],[],e,s,gg)
_(lCB,oHB)
}
var aDB=_v()
_(oBB,aDB)
if(_oz(z,3,e,s,gg)){aDB.wxVkey=1
var xIB=_mz(z,'meeting',['bind:__l',4,'vueId',1],[],e,s,gg)
_(aDB,xIB)
}
var tEB=_v()
_(oBB,tEB)
if(_oz(z,6,e,s,gg)){tEB.wxVkey=1
var oJB=_mz(z,'food',['bind:__l',7,'vueId',1],[],e,s,gg)
_(tEB,oJB)
}
var eFB=_v()
_(oBB,eFB)
if(_oz(z,9,e,s,gg)){eFB.wxVkey=1
var fKB=_mz(z,'user',['bind:__l',10,'vueId',1],[],e,s,gg)
_(eFB,fKB)
}
var bGB=_v()
_(oBB,bGB)
if(_oz(z,12,e,s,gg)){bGB.wxVkey=1
var cLB=_mz(z,'work',['bind:__l',13,'vueId',1],[],e,s,gg)
_(bGB,cLB)
}
var hMB=_n('view')
_rz(z,hMB,'class',15,e,s,gg)
var oNB=_mz(z,'view',['bindtap',16,'class',1,'data-cur',2,'data-event-opts',3],[],e,s,gg)
var cOB=_n('view')
_rz(z,cOB,'class',20,e,s,gg)
var oPB=_n('image')
_rz(z,oPB,'src',21,e,s,gg)
_(cOB,oPB)
_(oNB,cOB)
var lQB=_n('view')
...
_(oNB,lQB)
_(hMB,oNB)
var tSB=_mz(z,'view',['bindtap',24,'class',1,'data-cur',2,'data-event-opts',3],[],e,s,gg)
var eTB=_n('view')
_rz(z,eTB,'class',28,e,s,gg)
var bUB=_n('image')
_rz(z,bUB,'src',29,e,s,gg)
_(eTB,bUB)
_(tSB,eTB)
var oVB=_n('view')
...
_(tSB,oVB)
_(hMB,tSB)
var oXB=_mz(z,'view',['bindtap',32,'class',1,'data-cur',2,'data-event-opts',3],[],e,s,gg)
var fYB=_n('view')
_rz(z,fYB,'class',36,e,s,gg)
var cZB=_n('image')
_rz(z,cZB,'src',37,e,s,gg)
_(fYB,cZB)
_(oXB,fYB)
var h1B=_n('view')
...
_(oXB,h1B)
_(hMB,oXB)
var c3B=_mz(z,'view',['bindtap',40,'class',1,'data-cur',2,'data-event-opts',3],[],e,s,gg)
var o4B=_n('view')
_rz(z,o4B,'class',44,e,s,gg)
var l5B=_n('image')
_rz(z,l5B,'src',45,e,s,gg)
_(o4B,l5B)
_(c3B,o4B)
var a6B=_n('view')
...
_(c3B,a6B)
_(hMB,c3B)
var e8B=_mz(z,'view',['bindtap',48,'class',1,'data-cur',2,'data-event-opts',3],[],e,s,gg)
var b9B=_n('view')
_rz(z,b9B,'class',52,e,s,gg)
var o0B=_n('image')
_rz(z,o0B,'src',53,e,s,gg)
_(b9B,o0B)
_(e8B,b9B)
var xAC=_n('view')
...
var z=gz$gwx_9()
var eLC=_n('view')
var bMC=_mz(z,'scroll-view',['scrollY',-1,'class',0],[],e,s,gg)
var oNC=_mz(z,'cu-custom',['bgColor',1,'bind:__l',1,'vueId',2,'vueSlots',3],[],e,s,gg)
var xOC=_n('view')
_rz(z,xOC,'slot',5,e,s,gg)
...
var z=gz$gwx_10()
var x3C=_n('view')
var o4C=_mz(z,'scroll-view',['scrollY',-1,'class',0],[],e,s,gg)
var f5C=_mz(z,'cu-custom',['bgColor',1,'bind:__l',1,'vueId',2,'vueSlots',3],[],e,s,gg)
var c6C=_n('view')
...
var fID=_n('view')
_rz(z,fID,'class',16,oFD,bED,gg)
var cJD=_n('view')
_rz(z,cJD,'class',17,oFD,bED,gg)
var hKD=_v()
_(cJD,hKD)
if(_oz(z,18,oFD,bED,gg)){hKD.wxVkey=1
var oLD=_n('view')
_rz(z,oLD,'class',19,oFD,bED,gg)
var cMD=_v()
_(oLD,cMD)
if(_oz(z,20,oFD,bED,gg)){cMD.wxVkey=1
var oND=_oz(z,21,oFD,bED,gg)
_(cMD,oND)
}
cMD.wxXCkey=1
_(hKD,oLD)
...
var l3D=_n('view')
_rz(z,l3D,'class',33,hYD,cXD,gg)
var a4D=_v()
_(l3D,a4D)
if(_oz(z,34,hYD,cXD,gg)){a4D.wxVkey=1
var t5D=_n('view')
_rz(z,t5D,'class',35,hYD,cXD,gg)
var e6D=_v()
_(t5D,e6D)
if(_oz(z,36,hYD,cXD,gg)){e6D.wxVkey=1
var b7D=_oz(z,37,hYD,cXD,gg)
_(e6D,b7D)
}
e6D.wxXCkey=1
_(a4D,t5D)
...
var bKE=_n('view')
_rz(z,bKE,'class',48,aHE,lGE,gg)
var oLE=_n('view')
_rz(z,oLE,'class',49,aHE,lGE,gg)
var xME=_v()
_(oLE,xME)
if(_oz(z,50,aHE,lGE,gg)){xME.wxVkey=1
var oNE=_n('view')
_rz(z,oNE,'class',51,aHE,lGE,gg)
var fOE=_v()
_(oNE,fOE)
if(_oz(z,52,aHE,lGE,gg)){fOE.wxVkey=1
var cPE=_oz(z,53,aHE,lGE,gg)
_(fOE,cPE)
}
fOE.wxXCkey=1
_(xME,oNE)
...
cEE.wxXCkey=2
_2z(z,46,oFE,e,s,gg,cEE,'item','index','index')
_(o4C,oDE)
var cSE=_n('view')
