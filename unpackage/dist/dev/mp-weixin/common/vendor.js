...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": {}, "pages/index/home": {}, "pages/account/login": {}, "pages/account/register": {}, "pages/account/findPassword": {}, "pages/user/editPassword": {}, "pages/meeting/myMeetingRecordList": {}, "pages/meeting/meetingList": {}, "pages/meeting/bookMeeting": {} }, "globalStyle": { "navigationStyle": "custom" } };exports.default = _default;
      ...
      if (data.code) {
        if (data.code === "401")
        {
          if (getToken()) {
            ...
            return Promise.reject({ statusCode: statusCode, message: '未登录' });
          }
