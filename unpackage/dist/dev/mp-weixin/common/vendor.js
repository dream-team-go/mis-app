...
/* 4 */
/*!***********************************************!*\
  !*** /Users/yaoyuan/yy/my/mis-app/pages.json ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 15 */
/*!***************************************************!*\
  !*** /Users/yaoyuan/yy/my/mis-app/store/index.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    setLoginInfo: function setLoginInfo(state) {
    ...
    setLogoutInfo: function setLogoutInfo(state) {
...
/* 17 */
/*!******************************************************************!*\
  !*** /Users/yaoyuan/yy/my/mis-app/js_sdk/pocky-request/index.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 18 */
/*!***********************************************************************!*\
  !*** /Users/yaoyuan/yy/my/mis-app/js_sdk/pocky-request/core/index.js ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 19 */
/*!*****************************************************************************!*\
  !*** /Users/yaoyuan/yy/my/mis-app/js_sdk/pocky-request/core/interceptor.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 20 */
/*!*****************************************************************************!*\
  !*** /Users/yaoyuan/yy/my/mis-app/js_sdk/pocky-request/core/mergeConfig.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 21 */
/*!******************************************************************!*\
  !*** /Users/yaoyuan/yy/my/mis-app/js_sdk/pocky-request/tools.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 22 */
/*!*************************************************************************!*\
  !*** /Users/yaoyuan/yy/my/mis-app/js_sdk/pocky-request/core/network.js ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 23 */
/*!*******************************************************************!*\
  !*** /Users/yaoyuan/yy/my/mis-app/js_sdk/pocky-request/config.js ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.config = exports.globalInterceptor = void 0;var _interceptor = _interopRequireDefault(__webpack_require__(/*! ./core/interceptor */ 19));
var _index = _interopRequireDefault(__webpack_require__(/*! ./index */ 17));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
function (res, config) {
  ...
  try {
    return handleCode({ data: data, statusCode: statusCode, config: config });
  } catch (err) {
...
/**
   ...
   */
function handleCode(_ref) {var data = _ref.data,statusCode = _ref.statusCode,config = _ref.config;
  var STATUS = {
    '200': function _() {
      if (data.code) {
        if (data.code === "401")
        {
          if (getToken()) {
            ...
            return Promise.reject({ statusCode: statusCode, message: '身份过期' });
          }
          return Promise.reject();
        } else if (data.code === "403") {
          return Promise.reject({ statusCode: statusCode, message: '未授权' });
        }
      } else {
        return data;
      }
    ...
    '400': function _() {
      ...
      return Promise.reject({ statusCode: statusCode, message: '请求错误' });
    },
    '403': function _() {
      return Promise.reject({ statusCode: statusCode, message: '拒绝请求' });
    },
    '404': function _() {
      return Promise.reject({ statusCode: statusCode, message: '路径错误' });
    },
    '500': function _() {
      return Promise.reject({ statusCode: statusCode, message: '服务器错误' });
    } };
...
/* 38 */
/*!*******************************************************!*\
  !*** /Users/yaoyuan/yy/my/mis-app/common/mis-enum.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; //会议预定记录枚举
var MeetingRecordEnumMap = new Map([
[0, "待审批"],
[-2, "取消预定"],
[-1, "预定失败"],
[1, "预定成功"]]);
...
//用车申请枚举
var UseCarRecordEnumMap = new Map([
[0, "待审批"],
[-3, "申请人取消订单"],
[1, "审批通过"],
[-1, "审批未通过"],
...
//派车记录枚举
var DispatchRecordEnumMap = new Map([
[1, "等待出车"],
[2, "已出车"],
[3, "已归队"],
[4, "已结算"]]);
...
//建筑状态枚举
var BuildingStatusEnumMap = new Map([
[0, "未使用"],
[1, "在使用"]]);


//维修记录枚举
var RepairRecordEnumMap = new Map([
[1, "待审批"],
[0, "取消申请"],
[2, "组长通过"],
[-1, "组长未通过"],
...
//消息状态枚举
var WarnStatusEnumMap = new Map([
[0, "未读"],
[1, "已读"]]);


//工作餐类型枚举
var LeaderBookFoodEnumMap = new Map([
[1, "午餐"],
[2, "晚餐"]]);


var CarTypeEnumMap = new Map([
[0, "小轿车"],
[1, "越野车"],
[2, "商务车"],
[3, "中型客车"],
...
{
  MeetingRecordEnumMap: MeetingRecordEnumMap,
  FoodRecordEnumMap: FoodRecordEnumMap,
  BuildingStatusEnumMap: BuildingStatusEnumMap,
  UseCarRecordEnumMap: UseCarRecordEnumMap,
  DispatchRecordEnumMap: DispatchRecordEnumMap,
  RepairRecordEnumMap: RepairRecordEnumMap,
  WarnStatusEnumMap: WarnStatusEnumMap,
  LeaderBookFoodEnumMap: LeaderBookFoodEnumMap,
  CarTypeEnumMap: CarTypeEnumMap };exports.default = _default;
